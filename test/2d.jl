@testset "2D nonlinear problems" begin
    ...
    # a.k.a. 105_02
    # TODO: test fails "Not solved to optimality, status: Unbounded"
    #=
    @testset "e and log expressions, intersection point" begin
        m = Model(solver=solver)
    ...
    # a.k.a. 106_01
    # TODO: test fails with incorrect answer
    # out of scope becouse unless problem is non-convex in variable bounds
    #=
    ...
    # TODO: the next three tests fail due to convergence accuracy issues
    #=
    # a.k.a. 108_02
